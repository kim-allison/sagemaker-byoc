...
class KobertCRF(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, tags=None, input_tokenss=None):
        ...
        if input_tokenss is not None:
            for i, word in enumerate(input_tokenss):
                print(word, emissions[0][i])
            input()
...
class KobertBiLSTMCRF(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, tags=None, using_pack_sequence=False, input_tokenss=None):
